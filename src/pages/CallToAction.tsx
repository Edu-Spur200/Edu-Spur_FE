          ...
          <div className="bg-red-300 mx-auto w-full max-w-[500px] lg:max-w-none xxs:w-[100%] xxs:flex xxs:flex-wrap"  data-aos="fade-right" data-aos-duration="1000">
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm w-full">
              ...
              <div className="flex items-center p-6 pt-0">
                <button className="inline-flex items-center justify-center w-full h-10 px-4 py-2 text-sm font-medium text-white rounded-md bg-[#133b55] hover:bg-[#133b55] transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                  Submit Request
                </button>
              </div>
            </div>
